...
overridden process-wide with the `SGLANG_BOOTSTRAP_PORT` environment variable. A
non-integer value is rejected in favor of the default and logged at startup.
